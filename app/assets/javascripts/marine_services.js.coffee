$(document).ready ->
  onMarineServiceSubmit = (e) ->
    ...
    .success (response)->
      ...
      $notice.append('Thank you, your enquiry have been sent to us.')
      $this.prepend($notice)
    .error (response)->
  ...
  validetta_options = $.extend Rightboat.validetta_options, onValid: onMarineServiceSubmit
