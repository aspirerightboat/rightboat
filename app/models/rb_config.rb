class RBConfig < ActiveRecord::Base
  ...
  def self.repair
    configs = [
        ...
        {key: 'lead_price_coef', value: '0.0002', description: 'If boat has price is £100.000 then invoice price will be eg. 100_000 * 0.0002 = £20'},
        {key: 'lead_flat_fee', value: '99', description: 'If no boat price nor length present then invoice price will be flat fee in £'},
    ]
