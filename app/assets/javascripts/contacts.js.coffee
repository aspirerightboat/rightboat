$(document).ready ->
  ...
  validetta_options = $.extend Rightboat.validetta_options, onValid: onContactSubmit
  $('.contact-form').validetta validetta_options

  validetta_options = $.extend Rightboat.validetta_options, onValid: onSubscriptionSubmit
