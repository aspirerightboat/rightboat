  ...
  module Imports
    class SourceBoat
      ...
      SPEC_ATTRS = [
        ...
        :cockpit, :cockpit_cover, :cockpit_cushions, :cockpit_lightning, :cockpit_shower, :cockpit_speakers, :cockpit_table, :cockpit_table_cover, :cockpit_type,
        :compartments, :compass, :compass_year, :compressor,
        ...
        :engine, :engine_code, :engine_count, :engine_horse_power, :engine_horse_power2, :engine_hours, :engine_hours2, :engine_location, :engine_range_nautical_miles, :engine_tankage, :engine_type, :engine_type_name, :engine_year, :engine_year2, :engine_year_built,
