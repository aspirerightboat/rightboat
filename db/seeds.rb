...
spec_names = [
  ...
  {name: 'max_speed_knots',     display_name: 'Max Speed (knots)'},
  ...
  {name: 'berths_count',        display_name: 'Berths'},
  {name: 'single_berths_count',       display_name: 'Single Berths'},
  {name: 'double_berths_count',       display_name: 'Double Berths'},
  {name: 'heads_count',               display_name: 'No of Heads'},
  {name: 'cabins_count',        display_name: 'Cabins'},
