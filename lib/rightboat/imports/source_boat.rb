  ...
  module Imports
    class SourceBoat
      ...
      SPEC_ATTRS = [
        ...
        :crew_berths_count, :crew_cabins_count, :crockery, :cruise_speed_mph, :cruising_speed,
        ...
        :depth_instrument, :depth_sounder, :depth_sounder_year,
        :desalinator, :designer, :diesel_code, :dinette_sleeps,
        ...
        :engine, :engine_code, :engine_count, :engine_horse_power, :engine_horse_power2, :engine_hours, :engine_hours2, :engine_location,
        :engine_range_nautical_miles, :engine_tankage, :engine_type, :engine_type_name, :engine_year, :engine_year2, :engine_year_built,
        ...
        :hull_color, :hull_configuration, :hull_construction, :hull_designer, :hull_fuel_tank_material, :hull_material, :hull_number,
        :hull_painting, :hull_painting_year, :hull_shape, :hull_type, :hull_water_tank_material,
        ...
        :mainsail, :mainsail_battened, :mainsail_cars, :mainsail_cover, :mainsail_count, :mainsail_furler, :mainsail_furling, :mainsail_material,
        :mainsheet_traveller, :manual_bilge_pump, :marine_heads, :mast_pulpit, :masts, :material_code,
        :max_draft_meters, :max_load_capacity, :max_speed_knots, :max_speed_mph, :microwave, :mob_system, :mob_system_type,
        ...
        :radar, :radar_detector, :radar_detector_year, :radar_reflector, :radar_year,
        ...
        :rig, :rig_code, :rod_holders, :rope_cutter, :saloon, :searchlight, :seating_capacity, :seawater_pump, :shore_inverter,
        :shore_power, :shore_power_inlet, :shower, :solar_panels, :solar_panels_year, :solent,
        ...
        :stern_sunbathing, :stern_thruster, :storm_jib, :storm_jib_material, :sub_category, :sun_cover,
        :super_structure_colour, :super_structure_construction, :surveyed, :swimming_ladder, :swimming_platform,
