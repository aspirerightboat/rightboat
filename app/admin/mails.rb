  ...
  content title: "Mails" do
    ...
    columns do
      column do
        ...
        total_leads = Enquiry.where('saved_searches_alert_id IS NOT NULL').where(updated_at: @created_at_gteq.to_date.beginning_of_day.. @created_at_lteq.to_date.end_of_day).count
