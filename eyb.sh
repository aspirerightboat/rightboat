#!/bin/bash
echo "Updating File"
download="http://dealer-fr.eyb-boats.com/exports/RGB/out/auto/RGB_Out.xml"
...
xmlstarlet fo ./tmp/eyb.tmp.xml | iconv -c -fISO-8859-1 -tUTF-8 | sed 's/ISO-8859-1/UTF-8/g' > ./tmp/eyb.xml
rm ./tmp/eyb.tmp.xml

xmlstarlet validate -q ./tmp/eyb.xml
if [ $? == "1" ]; then
