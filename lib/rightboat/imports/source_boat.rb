...
module Rightboat
  module Imports
    class SourceBoat
      ...
      SPEC_ATTRS = [
        :hull_type, :hull_shape, :hull_material, :hull_color, :hull_construction, :hull_number, :hull_painting,
        ...
        :known_defects, :last_serviced, :air_draft,
        ...
        :windscreen_cover, :windscreen_wipers, :windlass_year, :windlass_name, :windlass_code, :windlass_power, :wind_generator,
        :washing_machine, :vcr, :upholstery_replacement, :tv, :tv_year, :trailor, :toerail_name, :toerail_code, :tiller,
        :teak_swimming_platform, :teak_side_decks, :teak_cockpit_table, :teak_cockpit, :swimming_platform, :swimming_ladder,
        :surveyed, :sun_cover, :storm_jib, :stern_sunbathing, :steering_wheel_cover, :stay, :sprayhood,
        :spinnaker, :spinnaker_sock, :spinnaker_rigging, :spinnaker_pole, :solent, :solar_panels, :shore_power_inlet,
        :seawater_pump, :saloon, :rod_holders, :rig_code, :repeater, :windspeed, :windspeed_year, :winch_cover,
        :removable_cockpit_table, :radiotape_player_year, :radiotape_player, :radar_detector, :radar_reflector,
        ...
        :leather_covered_steering_wheel, :lazyjacks, :lazybag, :launching_trailor, :inverter_year,
        ...
        :electric_bilge_pump, :dishwasher, :dinghy_year_engine, :diesel_code, :depth_sounder_year,
        :depth_sounder, :deck_name, :deck_code, :davits, :cutlery, :currency, :crockery, :cooker, :computer_year,
        ...
        :battened, :barbecue, :backstay, :autopilot_year, :anti_uv_strips, :anti_osmosis_treatment, :antifouling_year,
